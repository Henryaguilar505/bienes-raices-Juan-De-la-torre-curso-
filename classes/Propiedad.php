...
class Propiedad{
    ...
    public function __construct($args = [])
    {
        ...
        $this->vendedores_id = $args['vendedore_id'] ?? 1;  
    }
    ...
    public function atributos(){ //esta funcion solo mapea la propiedad de las columas con sus columnas respectivamente
        ...
        foreach(self::$columnasDB as $columna){ //recorremos cada inidce de cada columa
    ...
    //*metodo para listar todas lass propiedades
    ...
    //*metodo para listar una propiedad por su id
    ...
    public static function consultarSQL($query){
        ...
        $array[] = self::crearObjeto($registro); //iteremos cada resultado y lo pasamos al metodo de crear objeto
    ...
    public static function crearObjeto($registro){ //recibimos los resultados de una consulta en forma de array
        ...
        $objeto = new self;  //creamos un objeto de las misma clase (sin pasarle nada a los atributos aun);
